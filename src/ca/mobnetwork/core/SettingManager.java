...
public class SettingManager 
{
	...
	private void deleteFile(File f)
	{
		if(f.exists())
		{
			...
			{
				f.delete();
				Core.log.info("File : "+ f.getName() + " is now deleted !");
			}
			catch (Exception ex)
			{
				ex.printStackTrace();
		...
		{
			Core.log.info("Couldn't delete file : " + f.getName() + " (File doesn't exist !)");
		}
	}
	...
	public void addConfig(String name,String directory)
	{
		if(!this.isConfig(name))
		{
			...
			Core.log.info("Added config with name : " + name);
		} 
		else 
		{
			Core.log.info("Couldn't add config with name : " + name);
		}
	}
	...
	public void removeConfig(String name){
		if(this.isConfig(name))
		{
			configs.remove(name);
			removeFile(name);
			Core.log.info("Removed config : " + name);
		} else {
			Core.log.info("Couldn't remove config with name : " + name);
		}
	}
	...
	public void clear()
	{
		...
		files.clear();
		configs.clear();
		Core.log.info("Removed all Files & Configs");
	}
